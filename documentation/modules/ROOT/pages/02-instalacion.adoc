...
Por último el paquete *scap-workbench* nos servirá para generar perfiles custom de compliance, como veremos más adelante. Solamente añadir que también permite evaluar el compliance en local o en sistemas remotos a través de _SSH_.
