...
El paquete *openscap-scanner* instala la herramienta _oscap_ desde la cuál podremos lanzar los escaneos de compliance sobre nuestros sistemas, generar reports o incluso generar las remediaciones con Ansible.
...
Por último el paquete *scap-workbench* nos servirá para generar perfiles custom de compliance, como veremos más adelante. Sólo añadir que también permite evaluar el compliance en local o en sistemas remotos a través de _SSH_.
